...
// static const pin_t onboard_row_pins[MATRIX_ROWS] = { D4, B6, B2, B3, B1 };
// static const pin_t onboard_col_pins[MATRIX_COLS_ONBOARD] = { F6, F7, B5, B4, E6, D7, C6 };
